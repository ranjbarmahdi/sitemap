...
async function insertProductIdToProblem(productid) {
    ...
    if (!productIdInDb) {
        try {
            ...
            console.log(
                `Error in insertProductIdToProblem function : ${productid}\nError:`,
                error.message
            );
        }
    }
...
async function insertProductIdToVisited(productid) {
    ...
    if (!productIdInDb) {
        try {
            ...
            console.log(
                `Error in insertProductIdToVisited function : ${productid}\nError:`,
                error.message
            );
        }
    }
...
async function scrap(page, productId) {
    try {
        const productURL = `https://vardast.com/category/${productId}`;
